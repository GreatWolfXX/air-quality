      ...
      <div className="container">
        ...
        <div className="footer-text-wrap">
          ...
          <p className="footer-nav-text">
            Сайт разработал <span className="text-yellow">{author}</span> в учебных целях, в рамках образовательной программы IT nation. Дизайн сайта создан <span className="text-yellow">{designer}</span>.
          </p>
        </div>
